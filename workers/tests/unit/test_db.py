...
from agentic_workers.core import db


def test_create_engine_kwargs_adds_sqlite_connect_args() -> None:
    kwargs = db._create_engine_kwargs("sqlite:///../runtime/data/sqlite/agentic_workflow.db")
...
def test_create_engine_kwargs_leaves_non_sqlite_urls_unchanged() -> None:
    kwargs = db._create_engine_kwargs("postgresql://user:pass@localhost/app")
